...
and the gap between them (97.5% vs 86.2% today) looked like neglect. Ranked from the current scorecard
...
closures since #10 on the twenty-fifth wave): **13 categories, 31 gap points**.
