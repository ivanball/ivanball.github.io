...
and the gap between them (97.5% vs 86.4% today) looked like neglect. Ranked from the current scorecard
(2026-09-01 thirty-first wave: no membership or order change; #4, #5, #11, #13, #17, #30 and #34 came
back FLAG and are held at prior by merged-prior policy after adversarial refutation of their proposed
lifts, not re-confirmed fresh, while #12, #16, #23, #24, #29 and #31 re-confirmed fresh; prior thirtieth
wave, 2026-08-31: #8, #19, #25 and #26 closed at Implementation 9 and left the band, the band's first
closures since #10 on the twenty-fifth wave): **12 categories, 29 gap points** (the 2026-09-04 rubric v2 rebase retired the #16 row, struck through in the band).
...
| 2 | #13 | Observability & Operability | 2 | 8 | SLO-breach alerting with dashboards, plus runbooks for common failures, the two rubric criteria left to the deployer (the recorded reason the 8→9 lift was refuted on the twenty-fourth wave and on every cycle since; held at prior on FLAG on the thirtieth wave, 2026-08-31, the seventh consecutive refusal, and again on the thirty-first, 2026-09-01, the eighth: Common's own sample IaC declares an action group but no `Microsoft.Insights/metricAlerts` resource despite its own comment, `samples/deployment/main.bicep:156` (anchor corrected 2026-09-01), and the only runbook remains the #29 restore drill) |
