...
consumer today (`MMCA.ADC/Source/Services/MMCA.ADC.Identity.Service/Program.cs:258-262`,
`MMCA.ADC.Conference.Service/Program.cs:298-299`), and Store Sales consumes `ProductVariantChanged`
(`MMCA.Store/Source/Services/MMCA.Store.Sales.Service/Program.cs:194-195`); ADC Engagement and Notification
