...
bar ([ADR-004](https://ivanball.github.io/docs/adr/004-authentication-dual-fetch.html) covers the cross-service JWKS validation these tokens flow into). The
...
flash of the wrong language and no prerender/hydration mismatch ([ADR-027](https://ivanball.github.io/docs/adr/027-multi-locale-i18n.html), which supersedes the prior
single-locale stance of [ADR-011](https://ivanball.github.io/docs/adr/011-single-locale-i18n.html)). A single non-HttpOnly culture cookie is the source of truth: the WASM
...
`User.PreferredTheme` ([ADR-028](https://ivanball.github.io/docs/adr/028-dark-theme-mode.html), which reuses [ADR-027](https://ivanball.github.io/docs/adr/027-multi-locale-i18n.html)'s cookie/profile/bootstrap machinery rather than
...
flash on first paint is currently possible (tracked as an [ADR-028](https://ivanball.github.io/docs/adr/028-dark-theme-mode.html) follow-up).
...
`AddDeviceCapabilityDefaults()` so a form-factor contract resolves on every head ([ADR-042](https://ivanball.github.io/docs/adr/042-device-capability-abstraction.html))
...
([`IFormFactor`](group-26-device-capability-layer.md#iformfactor) and friends, [ADR-042](https://ivanball.github.io/docs/adr/042-device-capability-abstraction.html), group 26). The presentational helper
...
- **Why it's built this way**: A record gives value semantics and concise construction; making localization opt-in through a nullable `TitleResource` means the [ADR-027](https://ivanball.github.io/docs/adr/027-multi-locale-i18n.html) support was added without breaking any existing literal-titled registration.
...
- **What it is**: a `DelegatingHandler` that stamps the active UI culture onto every outgoing API
  ...
  chosen language ([ADR-027](https://ivanball.github.io/docs/adr/027-multi-locale-i18n.html)).
...
- **What it is**: the contract for persisting a signed-in user's culture/theme choice to the backend so
  it follows them across devices ([ADR-027](https://ivanball.github.io/docs/adr/027-multi-locale-i18n.html) / [ADR-028](https://ivanball.github.io/docs/adr/028-dark-theme-mode.html)).
...
- **What it is**: the circuit-scoped owner of the Day/Dark theme preference ([ADR-028](https://ivanball.github.io/docs/adr/028-dark-theme-mode.html)). It holds the
...
- **What it is**: a two-field DTO carrying a user's persisted UI preferences ([ADR-027](https://ivanball.github.io/docs/adr/027-multi-locale-i18n.html) / [ADR-028](https://ivanball.github.io/docs/adr/028-dark-theme-mode.html)), where
...
- **What it is**: the read contract for a returning user's persisted culture/theme, applied at login so a
  choice made on one device follows to another ([ADR-027](https://ivanball.github.io/docs/adr/027-multi-locale-i18n.html) / [ADR-028](https://ivanball.github.io/docs/adr/028-dark-theme-mode.html)).
...
- **What it is**: the Blazor WebAssembly culture bootstrap ([ADR-027](https://ivanball.github.io/docs/adr/027-multi-locale-i18n.html)). It reads the same ASP.NET culture
