...
window.ARTICLES = [
  ...
  { n: 13, cat: "data", adr: "ADR 035", title: "Optimistic concurrency: RowVersion round-trips", summary: "Carry the RowVersion from database to DTO and back, so a concurrent edit fails fast as a conflict instead of silently overwriting.", url: "" },
  { n: 14, cat: "data", title: "Self-ordering modules", summary: "Modules declare their dependencies and load in topological order, so registration is never hand-sequenced.", url: "" },
  { n: 15, cat: "data", adr: "ADR 010", title: "Event-schema versioning", summary: "Every integration event carries a schema version; breaking changes get a new event type and an upcaster, never a silent reshape.", url: "" },
  { n: 16, cat: "auth", adr: "ADR 004", title: "JWKS cross-service auth", summary: "Validate another service's RS256 tokens via JWKS discovery, with no shared secret crossing a boundary.", url: "" },
  { n: 17, cat: "auth", adr: "ADR 032", title: "Password hashing done right", summary: "The non-negotiables of password storage in .NET, done correctly and tested.", url: "" },
  { n: 18, cat: "auth", adr: "ADR 017/021", title: "Idempotency in one attribute", summary: "Dedup client retries with an Idempotency-Key header and cached replay, plus a consumer-side inbox for brokers.", url: "" },
