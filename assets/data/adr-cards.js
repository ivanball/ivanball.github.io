...
window.ADR_CARDS = {
  ...
  "053": { title: "Dual-registry package publishing", summary: "Every release pushes the same packages to nuget.org and GitHub Packages from one tag; nuget.org is the documented install path because the GitHub registry needs a token even for public packages." },
};
